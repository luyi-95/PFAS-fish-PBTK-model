...
for partition,points in [('OLD_HELDOUT',old),('REVISED_HELDOUT',new)]:
    for cc,cs in points:
        for dc,ds in dev:
            ...
            distance.append(dict(design=partition,CC=cc,CS=cs,development_CC=dc,development_CS=ds,delta_CC_deg=a,delta_CS_360_deg=b,delta_CS_120_deg=q,euclidean_degrees_360_360=math.hypot(a,b),euclidean_degrees_360_120=math.hypot(a,q),normalized_torus_distance_360_120=math.hypot(a/360,q/120),normalized_torus_distance_360_360=math.hypot(a/360,b/360)))
